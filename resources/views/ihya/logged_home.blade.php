...
@section('content')
    <div class="flex overflow-hidden flex-col bg-white">
        <main
            class="flex  relative flex-col px-16 pt-40 pb-32 mt-0 w-full text-3xl text-black min-h-[496px] max-md:px-5 max-md:pt-24 max-md:pb-28 max-md:max-w-full fade-in"
            role="main" style="background-color: #fffad7">
            <img loading="lazy" src="{{ asset('assets/src/home page main.png') }}"
                class="object-cover hidden md:block absolute inset-0 size-full" alt="Background decoration" />
            <h1 class="relative md:-right-2/4 z-10">
            ...
            <p class="relative md:-right-2/4 text-base z-10 mt-4">
                <span class="">Scroll and explore the hundreds of job affairs</span>
                <br />
                <span class=" leading-7">we have made up for you according to your interest</span>
            </p>
        </main>

        <!--  -->

        <section class="flex flex-col items-center mt-14 max-md:mt-10 fade-in" aria-labelledby="browse-section">
            <h2 id="browse-section" class="text-4xl text-center font-semibold text-black mb-3">
        ...
        <section class="fade-in mb-10 mx-6">
            <img loading="lazy" src="{{ asset('assets/src/path.svg') }} "
                class="block md:hidden object-contain  w-full
      my-14 mr-24   max-md:mt-10 max-md:max-w-full"
                alt="Job categories illustration">
            <img loading="lazy" src="{{ asset('assets/src/map homepage.svg') }} "
                class="hidden md:block object-contain mt-40 w-full
